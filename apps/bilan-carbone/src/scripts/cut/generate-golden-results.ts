/**
 * Regenerates apps/bilan-carbone/src/tests/fixtures/count/expected/*.json from situation fixtures.
 *
 * Run from repo root (after publicodes-count is compiled):
 *   yarn workspace bilan-carbone tsx src/scripts/cut/generate-golden-results.ts
 */
import fs from 'node:fs'
import path from 'node:path'
import { fileURLToPath } from 'node:url'
import Engine from 'publicodes'
import rules from '@abc-transitionbascarbone/publicodes-count/publicodes-build/index.js'
