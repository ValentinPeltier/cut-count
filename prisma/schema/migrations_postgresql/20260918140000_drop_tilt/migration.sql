...
WHERE "organization_version_id" IN (
  SELECT "id" FROM "bilan_carbone"."organization_versions" WHERE "environment" = 'TILT'
);

DELETE FROM "bilan_carbone"."user_application_settings"
WHERE "account_id" IN (
  SELECT "id" FROM "bilan_carbone"."accounts" WHERE "environment" = 'TILT'
);
